...
let AppComponent = class AppComponent {
    constructor(authService, router) {
        ...
        this.authService.loggedInUserChanged.subscribe((loggedInUser) => {
            this.loggedInUser = loggedInUser;
        });
        this.authService.isAuthChanged.subscribe((isAuth) => {
            this.isAuth = isAuth;
        });
        this.authService.isAdminChanged.subscribe((isAdmin) => {
...
/* harmony import */ var ng2_pdf_viewer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ng2-pdf-viewer */ "./node_modules/ng2-pdf-viewer/ng2-pdf-viewer.js");
...
let AllUsersProgressComponent = class AllUsersProgressComponent {
    constructor() {
    ...
    addPercentComplete(userProgress) {
...
let DepartmentProgressComponent = class DepartmentProgressComponent {
    constructor() {
    ...
    addPercentComplete(departmentProgress) {
...
let UserProgressComponent = class UserProgressComponent {
    constructor() {
...
let UserViewsComponent = class UserViewsComponent {
    constructor() {
        this.userSettings = [];
        this.allUsers = [];
...
let AuthService = class AuthService {
    constructor(router) {
        ...
        this.loggedInUserChanged.subscribe((user) => {
        ...
        this.isAuthChanged.subscribe((newIsAuth) => {
            this.isAuth = newIsAuth;
        });
        this.isAdminChanged.subscribe((newIsAdmin) => {
...
let ContractComponent = class ContractComponent {
    constructor(dialog, overlay, contractsService) {
        this.dialog = dialog;
...
let ViewContractComponent = class ViewContractComponent {
    constructor(data) {
...
let ContractsComponent = class ContractsComponent {
    ...
    ngOnInit() {
        this.contractsService.contractsChanged.subscribe((newContracts) => {
...
/* harmony import */ var ng2_pdf_viewer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ng2-pdf-viewer */ "./node_modules/ng2-pdf-viewer/ng2-pdf-viewer.js");
...
let ContractsService = class ContractsService {
    constructor(http) {
        ...
        this.contractsChanged.subscribe((contracts) => {
            this.contracts = contracts;
        });
        this.getContracts();
    }
    getContracts() {
        this.http.get(this.url).subscribe((contracts) => {
            this.contractsChanged.next(contracts);
        });
    }
    signContract(contract) {
        const contracts = this.contracts;
        this.contracts.map((currentContract) => {
...
let ContractsSummaryComponent = class ContractsSummaryComponent {
    constructor() {
        this.contracts = [];
    }
    get numSignedContracts() {
        return this.contracts.filter((contract) => contract.signed === true).length;
    }
    get numUnsignedContracts() {
        return this.contracts.filter((contract) => contract.signed === false).length;
    }
    get unsignedContracts() {
        return this.contracts.filter((contract) => contract.signed === false);
    }
    ngOnInit() {
    }
};
...
let HomeComponent = class HomeComponent {
    constructor(authService, trainingService, securityGroupsService, contractsService) {
        this.authService = authService;
    ...
    ngOnInit() {
        this.authService.loggedInUserChanged.subscribe((user) => {
            this.user = user;
        });
        this.trainingService.trainingsChanged.subscribe((trainings) => {
            this.trainings = trainings;
        });
        this.securityGroupsService.approvedGroupsChanged.subscribe((securityGroups) => {
            this.securityGroups = securityGroups;
        });
        this.contractsService.contractsChanged.subscribe((contracts) => {
            this.contracts = contracts;
        });
    }
};
...
let SecurityGroupsSummaryComponent = class SecurityGroupsSummaryComponent {
    constructor() {
        this.securityGroups = [];
    }
    ngOnInit() {
...
let TrainingsSummaryComponent = class TrainingsSummaryComponent {
    constructor() {
        this.trainings = [];
    }
    get numCompletedTrainings() {
        return this.trainings.filter((training) => training.progress === 100).length;
    }
    get numIncompleteTrainings() {
        return this.trainings.filter((training) => training.progress !== 100).length;
    }
    get incompleteTrainings() {
        return this.trainings.filter((training) => training.progress !== 100);
    }
    ngOnInit() {
    }
};
...
let AccessRequestComponent = class AccessRequestComponent {
    constructor(data) {
        this.closeDialog = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
let SecurityGroupComponent = class SecurityGroupComponent {
    constructor(dialog, overlay, securityGroupsService) {
        this.dialog = dialog;
        this.overlay = overlay;
        this.securityGroupsService = securityGroupsService;
...
let SecurityGroupsComponent = class SecurityGroupsComponent {
    constructor(securityGroupsService) {
        this.securityGroupsService = securityGroupsService;
        this.approvedGroups = [];
        this.deniedGroups = [];
    ...
    ngOnInit() {
        this.securityGroupsService.deniedGroupsChanged.subscribe((newSecurityGroups) => {
            this.deniedGroups = newSecurityGroups;
        });
        this.securityGroupsService.approvedGroupsChanged.subscribe((newSecurityGroups) => {
            this.approvedGroups = newSecurityGroups;
        });
        this.securityGroupsService.pendingGroupNumbersChanged.subscribe((groupNumbers) => {
            this.pendingGroupNumbers = groupNumbers;
        });
        this.securityGroupsService.approvedGroupNumbersChanged.subscribe((groupNumbers) => {
            this.approvedGroupNumbers = groupNumbers;
        });
    }
    raiseAccessRequest(group) {
...
let SecurityGroupsRoutingModule = class SecurityGroupsRoutingModule {
};
...
let SecurityGroupsModule = class SecurityGroupsModule {
};
...
let SecurityGroupsService = class SecurityGroupsService {
    constructor(http) {
        this.http = http;
        ...
        this.allGroupsChanged.subscribe((newSecurityGroups) => {
            this.allGroups = newSecurityGroups;
        });
        this.approvedGroupNumbersChanged.subscribe((approvedGroupNumbers) => {
            this.approvedGroupNumbers = approvedGroupNumbers;
            this.approvedGroupsChanged.next(this.allGroups.filter((group) => approvedGroupNumbers.indexOf(group.id) > -1 ||
                this.pendingGroupNumbers.indexOf(group.id) > -1));
            this.deniedGroupsChanged.next(this.allGroups.filter((group) => approvedGroupNumbers.indexOf(group.id) === -1 &&
                this.pendingGroupNumbers.indexOf(group.id) === -1));
        });
        this.pendingGroupNumbersChanged.subscribe((pendingGroupNumbers) => {
            this.pendingGroupNumbers = pendingGroupNumbers;
            this.approvedGroupsChanged.next(this.allGroups.filter((group) => this.approvedGroupNumbers.indexOf(group.id) > -1 ||
                pendingGroupNumbers.indexOf(group.id) > -1));
            this.deniedGroupsChanged.next(this.allGroups.filter((group) => this.approvedGroupNumbers.indexOf(group.id) === -1 &&
                pendingGroupNumbers.indexOf(group.id) === -1));
        });
        this.approvedGroupsChanged.subscribe((newApprovedGroups) => {
    ...
    getAllGroups() {
        this.http.get(this.allGroupsUrl).subscribe((allGroups) => {
            this.allGroupsChanged.next(allGroups);
        });
    }
    getApprovedGroupNumbers() {
        this.http.get(this.approvedGroupsNumbersUrl).subscribe((approvedGroupNumbers) => {
...
let MarkCompleteComponent = class MarkCompleteComponent {
    constructor(data) {
        this.closeDialog = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.training = data;
    }
...
let TrainingComponent = class TrainingComponent {
    constructor(trainingService, dialog, overlay) {
        this.trainingService = trainingService;
        this.dialog = dialog;
        this.overlay = overlay;
        this.trainings = [];
        this.trainingService.trainingsChanged.subscribe((newTrainings) => {
    ...
    updateProgress(training) {
        ...
        const sub = this.updateProgressDialogRef.componentInstance.closeDialog.subscribe((newProgress) => {
            this.dialog.closeAll();
...
let UpdateProgressComponent = class UpdateProgressComponent {
    constructor(data) {
        this.closeDialog = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.training = data;
...
let TrainingService = class TrainingService {
    constructor(http) {
        ...
        this.trainingsChanged.subscribe((trainings) => {
            this.trainings = trainings;
        });
        this.getTrainings();
    }
    getTrainings() {
        this.http.get(this.url).subscribe((trainings) => {
            this.trainingsChanged.next(trainings);
        });
    }
    completeTraining(trainingId) {
        let updatedTrainings = this.trainings;
    ...
    setTrainingProgress(trainingId, progress) {
        let updatedTrainings = this.trainings;
        updatedTrainings.map((training) => {
            if (training.id === trainingId) {
                if (progress == 0) {
...
let DestinationButtonComponent = class DestinationButtonComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
const approvedSecurityGroupsFixture = [1, 2, 5];
...
const departmentProgressFixture = [
    {
        completedTime: 615,
        departmentID: 1,
        name: "IT",
